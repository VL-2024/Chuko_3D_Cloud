window.CHUKO3D_CONFIG = Object.freeze({
  ...
  game: {
    ...
    scatterOutsideMetricMin: 1.72,
    scatterOutsideMetricMax: 1.88,
    scatterMinSeparationWorld: 0.64,
    scatterOutsideFanStepRad: 0.44,
    scatterOutsideFanJitterRad: 0.06,
    ...
    sakaDeterministicContactRadius: 0.10,
